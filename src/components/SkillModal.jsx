...
const SkillModal = ({ skill, image, isOpen, onClose }) => {
  const getSkillDescription = (skillName) => {
    const descriptions = {
      ...
      github:
        "Git을 통해 버전 관리를 효율적으로 수행하고, GitHub를 사용하여 팀원들과 협업할 수 있습니다. 이 도구들을 사용하는 이유는 코드 변경 이력을 체계적으로 관리하고 협업 효율을 높이기 위함입니다. 복잡한 머지 충돌을 해결하여 프로젝트를 관리한 경험이 있습니다.",
      figma:
        "Figma를 이용하여 디자인 작업과 개발 간의 협업을 원활하게 할 수 있습니다. 이를 선택한 이유는 실시간 협업 기능과 프로토타이핑이 용이하기 때문입니다. lo-fi, hi-fi 프로토타입을 제작하여 프로젝트에 적용한 경험이 있습니다.",
      ...
      redux:
        "Redux를 통해 전역 상태 관리를 구현해보았습니다. 한두 개의 프로젝트에서 사용해본 경험이 있으며, 선택한 이유는 복잡한 상태를 체계적으로 관리하기 위해서입니다.",
      recoil:
      ...
      nodejs:
        "Node.js를 사용하여 간단한 CRUD 서버를 구축해보았습니다. 선택한 이유는 JavaScript로 서버와 클라이언트를 모두 다룰 수 있기 때문입니다.",
      firebase:
        "Firebase를 활용하여 서버리스 애플리케이션을 개발하고, 인증 및 실시간 데이터베이스 기능을 구현할 수 있습니다. 이를 채택한 이유는 빠른 프로토타이핑과 백엔드 관리의 편의성 때문입니다.",
      reactquery:
        "프로젝트에서 React Query를 활용하여 서버 데이터 관리를 최적화하고 로딩/에러 상태를 효과적으로 처리한 경험이 있습니다. 이를 선택한 이유는 데이터 페칭, 캐싱, 동기화, 그리고 업데이트를 간편하게 처리하여 애플리케이션의 성능과 사용자 경험을 향상시킬 수 있기 때문입니다.",
      pug: "node.js로 서버를 구축하며 pug를 사용해보았습니다. 이를 선택한 이유는 빠른 템플릿 작성과 가독성을 높이기 위함입니다.",
      express:
        "Express를 사용하여 서버 사이드 개발을 경험해보았습니다. 간단한 RESTful API를 구축해보았으며, 선택한 이유는 JavaScript로 서버와 클라이언트를 모두 다룰 수 있기 때문입니다.",
      mongodb:
        "MongoDB를 사용하여 데이터베이스 관리를 경험해보았습니다. 이를 선택한 이유는 node.js와 연동하여 빠른 데이터 조회와 쓰기 성능을 높이기 위함입니다.",
    };
