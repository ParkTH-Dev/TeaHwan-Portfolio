...
const SkillModal = ({ skill, image, isOpen, onClose }) => {
  const getSkillDescription = (skillName) => {
    const descriptions = {
      ...
      pug: "Pug를 사용하여 빠르게 템플릿을 작성할 수 있습니다. 이를 선택한 이유는 빠른 템플릿 작성과 가독성을 높이기 위함입니다.",
      express:
        "Express를 사용하여 서버 사이드 개발을 경험해보았습니다. 간단한 RESTful API를 구축할 수 있으며, 선택한 이유는 JavaScript로 서버와 클라이언트를 모두 다룰 수 있기 때문입니다.",
      mongodb:
        "MongoDB를 사용하여 데이터베이스 관리를 효율적으로 수행할 수 있습니다. 이를 선택한 이유는 빠른 데이터 조회와 쓰기 성능을 높이기 위함입니다.",
    };
