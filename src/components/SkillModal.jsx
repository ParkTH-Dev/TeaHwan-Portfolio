...
프로젝트 진행 중 **비동기 처리**에서 발생한 콜백 지옥 문제를 **Promise**와 **Async/Await**를 활용하여 해결한 경험이 있습니다.`,
      ...
      nextjs: `**Next.js**를 활용해 **초록마을 WMS 시스템**의 프론트엔드를 **클린 아키텍처 기반**으로 유지보수하고 있으며, 
      페이지 라우팅과 컴포넌트 구조 개선을 통해 **개발 효율성과 가독성 향상**에 기여하고 있습니다. 
      또한, 개인 프로젝트에서는 **SSR(Server-Side Rendering)**과 **SSG(Static Generation)**을 직접 구현해본 경험이 있어, 
      다양한 렌더링 전략에 대한 이해도 보유하고 있습니다.`,
      ...
      **lo-fi**, **hi-fi 프로토타입**을 제작하여 프로젝트에 적용한 경험이 있습니다.`,
      ...
      firebase: `팀 프로젝트에서 **Firebase**를 활용해 **서버리스 환경**, **사용자 인증**, **실시간 데이터베이스** 등을 구현해본 경험이 있습니다.  
      **백엔드 구축 없이도 빠른 개발이 가능하다는 점**에서 유용하게 사용하였습니다.`,
      ...
      mui: `**MUI(Material UI)**를 활용해 **초록마을 WMS 시스템**의 화면을 개발하고 있으며, 현재도 **DataGrid**, **Modal**, **ThemeProvider** 등을 사용해 **운영 기능 유지보수 및 UI 개선 작업**을 진행하고 있습니다. 이를 선택한 이유는 **빠른 UI 구성**과 **일관된 디자인 시스템 적용**에 효과적이기 때문입니다.`,
      express: `**Express**를 사용하여 **서버 사이드 개발**을 경험해보았습니다. **간단한 RESTful API**를 구축해보았으며, 선택한 이유는 **JavaScript**로 서버와 클라이언트를 모두 다룰 수 있기 때문입니다.`,
      mongodb: `**MongoDB** 기반 시스템에서 **데이터 구조 파악 및 상태 확인**을 통해, 프론트엔드 기능 개발과 디버깅에 활용하고 있습니다. 
      또한, **Node.js**와 연동하여 **빠른 데이터 조회 및 저장**을 구현해본 경험이 있습니다.`,
    };
